...
public class GeneratoreContenutoControproposta implements GeneratoreContenutoNotifica<DatiContenutoControproposta> {
    ...
    public String generaContenuto(DatiContenutoControproposta dati) {
        return "<html>"
                ...
                + ".contatto { background: #ffebcc; padding: 15px; border-radius: 8px; text-align: center; margin-top: 20px; }"
                + ".contatto strong { color: #cc5500; }"
                + "</style>"
                + "</head>"
                + "<body>"
                ...
                + "<p>Hai ricevuto una controproposta per la tua offerta sull'immobile <strong>#" + dati.getTitoloAnnuncio() + "</strong>.</p>"

                // Sezione dettagli controproposta
                + "<div class='dettagli'>"
                + "<p><strong>Prezzo che hai proposto:</strong> €" + dati.getPrezzoProposto() + "</p>"
                + "<p><strong>Controproposta dell'agente:</strong> €" + dati.getPrezzoControproposta() + "</p>"
                + "</div>"
                ...
                + "<p>Ti consigliamo di contattare subito l'agente <strong>" + dati.getNomeAgente() + "</strong> per discutere la controproposta.</p>"
