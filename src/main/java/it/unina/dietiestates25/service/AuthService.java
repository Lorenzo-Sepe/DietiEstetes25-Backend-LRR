...
public class AuthService {
    ...
    public String changePassword(String oldPassword, String newPassword, String confirmPassword) {
        ...
        User user = userRepository.findById(UserContex.getUserCurrent().getId())
                .orElseThrow(() -> new ResourceNotFoundException(UserContex.getUserCurrent().getEmail(),
                        "Utente non trovato. Assicurati di essere autenticato correttamente."));
        ...
        try {// 6
            ...
            throw new RuntimeException(
                    "Errore al momento del salvataggio della nuova password\n non è stato possibile cambiare la password\nRiprova più tardi");
        }
